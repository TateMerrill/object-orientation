...
class Cat {
  ...
  let Cat1 = new Cat("Tony", "10", "Black");
...
let wizard1 = new Wizard ("Gandalf", "200", "YOU SHALL NOT PASS!");
...
//Code Here
let phone1 = new Phone("Apple", "iPhone 8", 700, "Red", 800);
let phone2 = new Phone("Apple", "iPhone 11", 900, "Black", 1000);
let phone3 = new Phone("Banana", "Banana 2", 1200, "Yellow", 1500)
/* 
...
//Code Here
const myFirstVehicle = new Vehicle(5, 'blue', 150000)
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(1, 'red', 1500, 'R6', true)
/*
...
//Code Here
const myFirstBoat = new Boat(12, 'black', 12000, 'Flying Dutchman', 'yacht', false)
/*
